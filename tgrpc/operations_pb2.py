...
_OPERATION.fields_by_name['payment'].message_type = common__pb2._MONEYVALUE
_OPERATION.fields_by_name['price'].message_type = common__pb2._MONEYVALUE
...
_PORTFOLIORESPONSE.fields_by_name['total_amount_shares'].message_type = common__pb2._MONEYVALUE
_PORTFOLIORESPONSE.fields_by_name['total_amount_bonds'].message_type = common__pb2._MONEYVALUE
_PORTFOLIORESPONSE.fields_by_name['total_amount_etf'].message_type = common__pb2._MONEYVALUE
_PORTFOLIORESPONSE.fields_by_name['total_amount_currencies'].message_type = common__pb2._MONEYVALUE
_PORTFOLIORESPONSE.fields_by_name['total_amount_futures'].message_type = common__pb2._MONEYVALUE
_PORTFOLIORESPONSE.fields_by_name['expected_yield'].message_type = common__pb2._QUOTATION
_PORTFOLIORESPONSE.fields_by_name['positions'].message_type = _PORTFOLIOPOSITION
_POSITIONSRESPONSE.fields_by_name['money'].message_type = common__pb2._MONEYVALUE
_POSITIONSRESPONSE.fields_by_name['blocked'].message_type = common__pb2._MONEYVALUE
...
_WITHDRAWLIMITSRESPONSE.fields_by_name['money'].message_type = common__pb2._MONEYVALUE
_WITHDRAWLIMITSRESPONSE.fields_by_name['blocked'].message_type = common__pb2._MONEYVALUE
_WITHDRAWLIMITSRESPONSE.fields_by_name['blocked_guarantee'].message_type = common__pb2._MONEYVALUE
_PORTFOLIOPOSITION.fields_by_name['quantity'].message_type = common__pb2._QUOTATION
_PORTFOLIOPOSITION.fields_by_name['average_position_price'].message_type = common__pb2._MONEYVALUE
_PORTFOLIOPOSITION.fields_by_name['expected_yield'].message_type = common__pb2._QUOTATION
_PORTFOLIOPOSITION.fields_by_name['current_nkd'].message_type = common__pb2._MONEYVALUE
_PORTFOLIOPOSITION.fields_by_name['average_position_price_pt'].message_type = common__pb2._QUOTATION
_PORTFOLIOPOSITION.fields_by_name['current_price'].message_type = common__pb2._MONEYVALUE
_PORTFOLIOPOSITION.fields_by_name['average_position_price_fifo'].message_type = common__pb2._MONEYVALUE
_PORTFOLIOPOSITION.fields_by_name['quantity_lots'].message_type = common__pb2._QUOTATION
...
_BROKERREPORT.fields_by_name['price'].message_type = common__pb2._MONEYVALUE
_BROKERREPORT.fields_by_name['order_amount'].message_type = common__pb2._MONEYVALUE
_BROKERREPORT.fields_by_name['aci_value'].message_type = common__pb2._QUOTATION
_BROKERREPORT.fields_by_name['total_order_amount'].message_type = common__pb2._MONEYVALUE
_BROKERREPORT.fields_by_name['broker_commission'].message_type = common__pb2._MONEYVALUE
_BROKERREPORT.fields_by_name['exchange_commission'].message_type = common__pb2._MONEYVALUE
_BROKERREPORT.fields_by_name['exchange_clearing_commission'].message_type = common__pb2._MONEYVALUE
_BROKERREPORT.fields_by_name['repo_rate'].message_type = common__pb2._QUOTATION
